...
$('tr').each(function(i, elem) {
     ...
     address = address.trim().split(',')[0].split('.')[0].split('-')[0];
     x.push(address);
});
...
// log array of addresses to console, # of addresses
console.log(x);
console.log(x.length)

// save array to file
//fs.writeFile('/home/ec2-user/environment/data/week2/address2.txt', JSON.stringify(x));